...
def default_ndjson(model, category=None, net_score=None, net_score_latency=None, ramp_up_time=None, ramp_up_time_latency=None, bus_factor=None, bus_factor_latency=None,
    ...
    ndjson["net_score_latency"] = (ndjson["ramp_up_time_latency"] + ndjson["bus_factor_latency"] + ndjson["performance_claims_latency"] + ndjson["license_latency"] + 
        ndjson["size_score_latency"] + ndjson["dataset_and_code_score_latency"] + ndjson["dataset_quality_latency"] + ndjson["code_quality_latency"])
